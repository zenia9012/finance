    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading text-center"><h3>Продукт Редагувати</h3></div>
            </div>
            <div class="image">
                <img src="" alt="" width="160" height="120">
            </div>
            <form action="" class="form-horizontal" id="product-data" method="post">
                {{csrf_field()}}
                <div class="col-md-6">
                    <div class="personal-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="price_our" name="price_our" value="{{$product->price_our}}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="price_sell" class="col-sm-3 control-label">Ціна</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="price_sell" name="price_sell" value="{{$product->price_sell}}">
                            </div>
                        </div>
                        <div class="form-group">
