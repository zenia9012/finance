    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading text-center"><h3>Клієнт Редагувати</h3></div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="personal-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="facebook" name="facebook" value="{{ $client->facebook }}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control " id="notes" name="notes" value="{{ $client->notes }}">
                            </div>
                        </div>
                        @if($errors->any())
                            <div class="row">
